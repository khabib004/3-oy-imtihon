...
const categoriyProductsRow = document.querySelector( ".categoriy-products-row" );
...
function getProductCard( product ) {
  ...
  productPrice.textContent = "Фрукты и овощи";
...
let categoriyProducts = products.slice( -4 );

categoriyProducts.map( ( product ) => {
  let card = getProductCard( product );
  categoriyProductsRow.append( card );
} );
